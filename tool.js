! function() {
    ...
    if (__pvShareBtn) {
        __pvShareBtn.onclick = function() {
            ...
            var __pvShareOk = function(t) {
                try {
                    var ta = document.createElement("textarea");
                    ta.value = null == t ? "" : String(t);
                    ta.style.cssText = "position:fixed;top:-9999px;left:-9999px;opacity:0;";
                    document.body.appendChild(ta);
                    ta.focus();
                    ta.select();
            ...
            __pvShareOk ? q("URLをコピーしました", !1, "#16a34a", 2000) : q("コピーできませんでした", !0)
        }
    }
    try {
    ...
    function V() {
        ...
        if (I.querySelectorAll(".__pv_apply").forEach(function(e) {
                ...
                j || (localStorage.removeItem(s), q("全削除しました"), J())
